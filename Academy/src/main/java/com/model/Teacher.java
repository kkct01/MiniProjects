...
public class Teacher {
	...
	public Teacher(String lname, String fname, String email, String phone, String subject, String class_start,
			String class_finish) {
		super();
		this.lname = lname;
		this.fname = fname;
	...
	public String toString() {
		return "Teacher name: " + fname + lname + "|||" + "Email: " + email + "|||" + "Phone number: " + phone + "|||" + "Subject: " + subject + "|||" + "Class start: " + 
